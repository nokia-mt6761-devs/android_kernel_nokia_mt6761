...
// mtk 
	...
	selective_read_eeprom(0x001c, &af_pos[0]);
	selective_read_eeprom(0x001d, &af_pos[1]);
	selective_read_eeprom(0x001e, &af_pos[2]);
	selective_read_eeprom(0x001f, &af_pos[3]);
